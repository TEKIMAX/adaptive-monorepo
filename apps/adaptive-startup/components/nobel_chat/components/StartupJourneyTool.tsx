...
const StartupJourneyTool: React.FC<StartupJourneyToolProps> = ({
    ...
    return (
        <div className="bg-white border border-nobel-gold/30 rounded-xl overflow-hidden shadow-sm my-4 max-w-md">
            <div className="bg-[#F9F8F4] px-4 py-3 border-b border-stone-100 flex justify-between items-center">
                <div className="flex items-center gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-nobel-gold"></div>
                    <span className="text-xs font-bold uppercase tracking-wider text-stone-500">Draft Milestone</span>
                </div>
                <span className="text-[10px] bg-stone-100 text-stone-400 px-2 py-0.5 rounded-full">AI Suggestion</span>
            </div>
            ...
            <div className="p-4 space-y-4">
                ...
                <button
                    onClick={handleSave}
                    disabled={isSaving}
                    className="w-full py-2.5 bg-stone-900 text-white rounded-lg text-xs font-bold uppercase tracking-widest hover:bg-nobel-gold transition-colors shadow-lg flex items-center justify-center gap-2"
                >
