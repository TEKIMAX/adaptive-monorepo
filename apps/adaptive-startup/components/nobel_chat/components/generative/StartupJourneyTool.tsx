        ...
        <div className="my-6 w-full bg-white border border-nobel-gold/20 rounded-xl overflow-hidden shadow-md animate-fade-in-up">
            ...
            <div className="p-4 space-y-4">
                ...
                <button
                    onClick={handleSave}
                    disabled={isSaving}
                    className="w-full py-2.5 bg-nobel-gold text-white rounded-full text-xs font-bold uppercase tracking-widest hover:bg-[#A38035] transition-colors shadow-lg hover:shadow-xl active:scale-95 flex items-center justify-center gap-2"
                >
