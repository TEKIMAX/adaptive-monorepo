                        ...
                        <div className="bg-stone-900/50 border border-stone-800 p-8 rounded-2xl h-full flex flex-col">
                            ...
                            <div className="mt-8 pt-6 border-t border-stone-800">
                                <h3 className="text-white font-serif mb-4 flex items-center gap-2">
                                    <span className="text-nobel-gold">+</span> Add Power
                                </h3>

                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <span className="text-stone-400 text-sm">Pack Size</span>
                                        <span className="text-white font-mono font-bold">{tokenPacks}M Tokens</span>
                                    </div>
                                    ...
                                    <input
                                        ...
                                        className="w-full h-1.5 bg-stone-800 rounded-lg appearance-none cursor-pointer accent-nobel-gold hover:accent-yellow-400"
                                    />

                                    <button
                                        onClick={handleBuyTokens}
                                        disabled={loading}
                                        className="w-full flex items-center justify-between bg-stone-800 hover:bg-stone-700 text-white p-4 rounded-xl transition-all group"
                                    >
                                        <span className="font-bold text-sm">Buy Now</span>
                                        <span className="font-mono text-nobel-gold text-sm group-hover:translate-x-1 transition-transform">
                                            ${tokenPacks * 10} <span className="text-stone-500 ml-1">→</span>
                                        </span>
                                    </button>
                                </div>
                            </div>
