...
import { PageAccess, RoleDefinition, RolePermissions, DEFAULT_ROLES, ViewState, StartupData } from '../types';
...
export function useAccessControl({
    ...
    }, [currentProject, user, customRoles, entitlements.tierName]);
    ...
    const isAccessDenied = useMemo(() => {
        ...
        // DEBUG: Trace checks
        // console.log("AccessCheck:", { viewState, userRole: currentUserRole, allowedPages: currentUserAllowedPages?.length });
