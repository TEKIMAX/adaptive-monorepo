...
export const UI_TOOLS = [
    ...
    },
    {
        ...
        function: {
            ...
            description: 'Renders a flowchart or process diagram.',
            parameters: {
                type: "object",
                properties: {
                    title: { type: "string" },
    ...
    },
    {
        ...
        function: {
            ...
            description: 'Renders a visualization for TAM, SAM, SOM.',
            parameters: {
                type: "object",
                properties: {
                    tam: { type: "number" },
                    sam: { type: "number" },
                    som: { type: "number" },
                    unit: { type: "string", description: "Currency or Users" }
                },
                required: ['tam', 'sam', 'som']
            }
        }
    },
    actionCardTool, // Added Action Card to Tools
    executionAuditTool // Added Execution Audit
];
