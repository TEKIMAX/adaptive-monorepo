            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed top-0 right-0 h-full w-full sm:w-[480px] bg-white shadow-[-8px_0_30px_rgba(0,0,0,0.12)] z-[70] flex flex-col border-l border-stone-100"
                    >
                        {/* Header */}
                        <div className="flex items-center justify-between p-8 pb-6 border-b border-stone-100 bg-white/80 backdrop-blur sticky top-0 z-10">
                            <div>
                            ...
                            <button
                                onClick={onClose}
                                className="p-2 -mr-2 text-stone-400 hover:text-stone-900 hover:bg-stone-50 rounded-full transition-all"
                            >
                                <X className="w-6 h-6" />
                            </button>
                        </div>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-stone-50 rounded-2xl p-6 border border-stone-100">
                                    <div className="flex items-start gap-4">
                                        <div className="flex-shrink-0 p-3 bg-white rounded-xl shadow-sm border border-stone-100">
                                            <Brain className="w-6 h-6 text-[#C5A059]" />
                                        </div>
                                        <div>
                                            <h3 className="font-bold text-stone-900 text-lg mb-1">Target: {topic}</h3>
