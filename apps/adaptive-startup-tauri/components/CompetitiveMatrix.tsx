...
const CompetitiveMatrix: React.FC<CompetitiveMatrixProps> = ({
    ...
    return (
        <div className="h-screen flex flex-col bg-nobel-cream canvas-pattern overflow-hidden">
            {/* Header */}
            <header className="flex items-center justify-between px-6 py-3 border-b border-stone-200 bg-white/80 backdrop-blur-sm shrink-0 z-20">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-purple-600 text-white rounded-full text-xs font-bold uppercase tracking-widest hover:bg-purple-700 transition-colors flex items-center gap-2"
                    >
                    ...
                    {canEdit && (
                        <button
                            ...
                            className={`px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest flex items-center gap-2 transition-colors ${isGenerating
                    ...
                    {canEdit && (
                        <button
                            ...
                            className="px-4 py-2 bg-nobel-gold text-white rounded-full text-xs font-bold uppercase tracking-widest hover:bg-[#a68546] transition-colors flex items-center gap-2"
                        >
