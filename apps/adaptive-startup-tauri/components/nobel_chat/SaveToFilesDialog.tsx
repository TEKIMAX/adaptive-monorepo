...
export const SaveToFilesDialog: React.FC<SaveToFilesDialogProps> = ({ isOpen, onClose, projectId, onSave, title = "Save to Files" }) => {
    const [selectedFolderId, setSelectedFolderId] = useState<string | null>(null);
    const [filename, setFilename] = useState("New AI Document");
    ...
    const items: FileSystemItem[] = useMemo(() => {
        ...
        // We only really care about folders for saving, but showing files helps context
