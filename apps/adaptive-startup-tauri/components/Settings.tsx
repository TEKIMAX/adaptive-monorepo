...
import { ArrowLeft, Globe, DollarSign, Lock, Users, User, ShieldCheck, Plug, LayoutGrid } from 'lucide-react';
...
type SettingsTab = 'profile' | 'users' | 'domains' | 'organizations' | 'security' | 'integrations' | 'billing';
                ...
                <div className="px-8 pt-8 pb-4 border-b border-stone-100 bg-white sticky top-0 z-10 w-full overflow-x-auto">
                    <div className="max-w-4xl mx-auto flex items-center gap-2 min-w-max">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium transition-all ${activeTab === 'users' ? 'bg-stone-900 text-white shadow-md' : 'bg-stone-100 text-stone-500 hover:bg-stone-200 hover:text-stone-900'}`}
                        >
                        ...
                        */}
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium transition-all ${activeTab === 'billing' ? 'bg-stone-900 text-white shadow-md' : 'bg-stone-100 text-stone-500 hover:bg-stone-200 hover:text-stone-900'}`}
                        >
                        ...
                        {activeTab === 'users' && (
                            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-400">
                                <div className="flex flex-col gap-1">
                                    <h2 className="font-serif text-2xl font-bold text-stone-900">Team Management</h2>
                                    <p className="text-stone-500 text-sm">Manage members, roles, and invitations for your organization.</p>
                                </div>

                                <div className="bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden">
                                    <WorkOSUserManagement orgId={currentProject?.orgId || ''} />
                                </div>
                            </div>
                        )}
