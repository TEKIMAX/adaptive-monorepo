...
export const CustomInvoicesTab: React.FC<CustomInvoicesTabProps> = ({ stripeAccountId }) => {
    const listInvoices = useAction(api.stripe.listConnectedInvoices);
    const createInvoice = useAction(api.stripe.createConnectedInvoice);
    const deleteInvoice = useAction(api.stripe.deleteConnectedInvoice);
