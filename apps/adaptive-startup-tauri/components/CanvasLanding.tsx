                            ...
                            <div className="mb-8 p-6 bg-nobel-gold/10 border border-nobel-gold/20 rounded-2xl">
                                <div className="flex items-center justify-between">
                                    ...
                                    <button
                                        ...
                                        className="px-6 py-3 bg-nobel-gold text-white rounded-full text-xs font-bold uppercase tracking-widest hover:bg-[#A38035] transition-all flex items-center gap-2 shadow-lg"
                                    >
