...
export const CustomProductsTab: React.FC<CustomProductsTabProps> = ({ stripeAccountId }) => {
    const listProducts = useAction(api.stripe.listConnectedProducts);
    const createProduct = useAction(api.stripe.createConnectedProduct);
    const archiveProduct = useAction(api.stripe.archiveConnectedProduct);
