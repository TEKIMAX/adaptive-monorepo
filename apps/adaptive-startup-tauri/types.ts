...
export interface ToolResult {
  type: 'chart' | 'table' | 'pitch_deck' | 'image' | 'model_canvas' | 'startup_journey' | 'customer_cards' | 'financial_snapshot' | 'swot_analysis' | 'okr_card' | 'market_sizing' | 'legal_risk' | 'process_flow' | 'action_card';
  data: any;
}
